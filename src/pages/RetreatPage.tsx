...
const RetreatPage: React.FC = () => {
  return (
    <div className="retreat-page-container">
      ...
      {/* 5. Who Should Attend */}
      <div className="theme-cyan" data-aos="fade-left" data-aos-duration="800" data-aos-delay="230"><RetreatAudience /></div>
      {/* 6. Meet the Mentors */}
      <div className="theme-plum" data-aos="fade-right" data-aos-duration="800" data-aos-delay="200"><RetreatMentors /></div>
      {/* 7. Schedule & Timeline */}
      <div className="theme-amber" data-aos="fade-up" data-aos-duration="800" data-aos-delay="140"><RetreatItinerary /></div>
      {/* 8. Daily Experiences */}
      <div className="theme-lime" data-aos="fade-up" data-aos-duration="800" data-aos-delay="170"><RetreatDaily /></div>
      {/* 9. Special Activities */}
      <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="250"><RetreatActivities /></div>
      {/* 10. Accommodation Details */}
      <div className="theme-sand" data-aos="zoom-in" data-aos-duration="850" data-aos-delay="260"><RetreatVilla /></div>
      {/* 11. Resort Experience & Payment */}
      <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="270"><RetreatStay /></div>
      {/* 12. Food & Dining */}
      <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="280"><RetreatCuisine /></div>
      {/* 13. What to Bring & Guidelines */}
      <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="285"><RetreatEssentials /></div>
      {/* 14. Limited Seats & Pricing */}
      <div className="theme-mint" data-aos="zoom-in-up" data-aos-duration="850" data-aos-delay="260"><RetreatSeats /></div>
      {/* 15. Transport Arrangements */}
      <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="290"><TransportArrangements /></div>
      {/* 16. Transport Details Page */}
      <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="295"><TransportPage /></div>
      {/* 17. Writing Plan Support */}
      <div data-aos="fade-up" data-aos-duration="800" data-aos-delay="300"><BookWritingPlan /></div>
