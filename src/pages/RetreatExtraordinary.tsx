      ...
      <div className="retreat-extraordinary-inner retreat-inner">
        ...
        <div className="extra-grid">
          <div className="extra-row">
            <img className="extra-img" src="https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600&h=400&fit=crop&q=80" alt="Inspiring Location" />
          ...
          <div className="extra-row">
            <img className="extra-img" src="https://images.unsplash.com/photo-1631049307264-da0ec9d70304?w=600&h=400&fit=crop&q=80" alt="Premium Comfort" />
            <div className="extra-item">
              <div className="extra-top">
                <div className="extra-icon" aria-hidden>
          ...
          <div className="extra-row">
            <img className="extra-img" src="https://images.unsplash.com/photo-1484480974693-6ca0a78fb36b?w=600&h=400&fit=crop&q=80" alt="Flexible Writing Time" />
            <div className="extra-item">
              <div className="extra-top">
                <div className="extra-icon" aria-hidden>
          ...
          <div className="extra-row">
            <img className="extra-img" src="https://images.unsplash.com/photo-1552664730-d307ca884978?w=600&h=400&fit=crop&q=80" alt="Expert Mentorship" />
            <div className="extra-item">
              <div className="extra-top">
                <div className="extra-icon" aria-hidden>
          ...
          <div className="extra-row">
           <img className="extra-img" src="/SparkWritersRetreat/location-4.jpg" />
             <div className="extra-item">
              <div className="extra-top">
                <div className="extra-icon" aria-hidden>
          ...
          <div className="extra-row">
            <img className="extra-img" src="https://images.unsplash.com/photo-1452587925148-ce544e77e70d?w=600&h=400&fit=crop&q=80" alt="Transformative Experience" />
            <div className="extra-item">
              <div className="extra-top">
                <div className="extra-icon" aria-hidden>
